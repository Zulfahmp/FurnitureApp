...
public class ListKursiActivity extends AppCompatActivity {
    ...
    String jenis_barang = "kursi";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_list_kursi);

        loadingDialog = new LoadingDialog(ListKursiActivity.this);

        MrecyclerView = findViewById(R.id.recyclerView);

        viewAdapter = new KursiAdapter (ListKursiActivity.this, results);
        RecyclerView.LayoutManager mlayoutManager = new LinearLayoutManager(ListKursiActivity.this);
...
//                Toast.makeText(MainActivity.this, "Tidak ada koneksi!", Toast.LENGTH_SHORT).show();
    ...
    public void cek(){
        if(adaInternet()){
            ...
            // tampilkan pesan
            Toast.makeText(ListKursiActivity.this, "Tidak ada koneksi internet", Toast.LENGTH_LONG).show();
        }
    }
}
