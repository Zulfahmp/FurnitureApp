...
import com.zulfa.furnitureapp.Adapter.RecyclerViewAdapterSukses;
...
public class FragmentSuccess extends Fragment {
    ...
    private RecyclerViewAdapterSukses viewAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewAdapter = new RecyclerViewAdapterSukses(getContext(), results);
