...
import com.zulfa.furnitureapp.Adapter.RecyclerViewAdapterPending;
...
public class FragmentPending extends Fragment {
    ...
    private RecyclerViewAdapterPending viewAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewAdapter = new RecyclerViewAdapterPending(getContext(), results);
